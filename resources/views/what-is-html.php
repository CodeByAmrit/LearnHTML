  ...
  <h1>What is HTML?</h1>      
  <p>HTML (HyperText Markup Language) is used to structure and format the content of websites on the World Wide Web. Web Developers use it to create a skeleton of modern websites and web apps.</p>              
  <hr>
  
  <h2>What is HTML?</h2>      
  <p>In simple words, HTML is the primary building block to create and structure website content.</p>
  <p>Let's see what HyperText Markup Language means.</p>       
  <li><strong>HyperText</strong></li>
  <p>HyperText is a way of organizing text that allows the reader to easily navigate and access related information. It takes the reader to a different part of the same web page, or to a different web page altogether.</p>
  <li><strong>Markup language</strong></li>
  <p>A markup language is a computer language that is used to add structure and formatting to a text document. Markup languages use a system of tags to define the structure and content of a document. These tags are interpreted by a program or application to display the document in a specific way.</p>
  ...
  <div class="showCode">
<code>
<img src="pic/copy.svg" alt="copy" onclick="copyFunction()">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
&lt;/html&gt;
  ...
  <li>&lt;h1&gt; tag - displays the content inside it as a heading</li>
  <li>&lt;p&gt; tag - displays the content inside it as a paragraph</li>
  <li>&lt;center&gt; tag - displays contents inside it at the center of the page</li>
  <hr>
  <h2>How to create and run an HTML file?</h2>
